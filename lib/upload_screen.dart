...
for (int i = 0; i < files.length; i++) {
    formData.files.add(MapEntry("songs[]", files[i]));  // Explicitly mark as an array
}

formData.fields.add(MapEntry("durations", jsonEncode(durations)));  // Send durations as JSON string
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      elevation: 3,
                      child: ListTile(
                        leading: Icon(Icons.music_note, color: Colors.orange, size: 30),
